...
<?=getNotificationHtml();?>
  ...
  <div class="row">
    <div class="col-md-7 col-lg-8 col-sm-12 col-xs-12">
      <div class="blog-news m-b-15">
        <div class="vcarousel slide"> 
          <!-- Carousel items -->
          <div class="carousel-inner">
            <div class="active item">
              <div class="overlaybg" style="background:url(<?=base_url();?>assets-admin/plugins/images/news/slide6.jpg) no-repeat center center /cover"></div>
        ...
        <div id="myCarouse2" class="carousel vcarousel slide p-20"> 
          ...
          <div class="carousel-inner">
            <div class="active item">
              ...
              <div class="twi-user"><img src="<?=base_url();?>assets-admin/plugins/images/users/hritik.jpg" alt="user" class="img-circle img-responsive pull-left">
            ...
            <div class="item">
              <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
              <div class="twi-user"><img src="<?=base_url();?>assets-admin/plugins/images/users/genu.jpg" alt="user" class="img-circle img-responsive pull-left">
                <h4 class="text-white m-b-0">Govinda</h4>
                <p class="text-white">Actor</p>
              </div>
            </div>
            <div class="item">
              <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
              <div class="twi-user"><img src="<?=base_url();?>assets-admin/plugins/images/users/ritesh.jpg" alt="user" class="img-circle img-responsive pull-left">
                <h4 class="text-white m-b-0">Govinda</h4>
                <p class="text-white">Actor</p>
              </div>
            </div>
      ...
      <div class="white-box">
        ...
        <div class="table-responsive">
          <table class="table ">
            ...
            <tbody>
              <tr>
                <td class="txt-oflo">Antworks Money admin</td>
      ...
      <div class="white-box">
        ...
        <div class="chat-box">
          <ul class="chat-list slimscroll">
            <li>
              <div class="chat-image"> <img alt="male" src="<?=base_url();?>assets-admin/plugins/images/users/sonu.jpg"> </div>
              <div class="chat-body">
                <div class="chat-text">
                  <h4>Sonu Nigam</h4>
                  <p> Hi, All! </p>
            ...
            <li class="odd">
              <div class="chat-image"> <img alt="Female" src="<?=base_url();?>assets-admin/plugins/images/users/genu.jpg"> </div>
              <div class="chat-body">
                <div class="chat-text">
                  <h4>Genelia</h4>
            ...
            <li>
              <div class="chat-image"> <img alt="male" src="<?=base_url();?>assets-admin/plugins/images/users/ritesh.jpg"> </div>
              <div class="chat-body">
                <div class="chat-text">
                  <h4>Ritesh</h4>
