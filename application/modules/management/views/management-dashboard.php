        ...
        <div class="left-aside">
          <div class="scrollable">
            ...
            <? }?>
              ...
              <li class="box-label"><a href="javascript:void(0)" data-toggle="modal" data-target="#myModal">+ Create New Role</a></li>
            ...
            <div class="table-responsive">
              <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?=$i;?></td>
                    <td><a href="<?=base_url();?>management/edit_user/<?=$row['user_id'];?>"><img src="<?=base_url();?>uploads/users/<?=$row['profilepic'];?>" alt="" class="img-circle"/> <?=$row['fullname'];?></a></td>
                    <td><?=$row['email'];?></td>
                    <td><?=$row['mobile'];?></td>
